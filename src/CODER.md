...
- **Be concise** — Every sentence must add value. No repetition, no filler, no restating what the human already said. Bullet points over prose. If it can be said in one line, don't use three.
...
**Writing rule for ALL sections** — Be concise, professional, and high-value. Every line must earn its place. No verbose introductions, no repeating the human's words back, no obvious statements. Prefer tables and bullet points over paragraphs. One idea per line. Dense, actionable, precise.
